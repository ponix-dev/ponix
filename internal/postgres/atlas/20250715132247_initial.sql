...
CREATE TABLE "end_devices" ("id" character(20) NOT NULL, "name" text NOT NULL, "description" text NULL, "organization_id" character(20) NOT NULL, "status" integer NOT NULL DEFAULT 1, "data_type" integer NOT NULL DEFAULT 0, "hardware_type" integer NOT NULL DEFAULT 1, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id"), CONSTRAINT "end_devices_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
