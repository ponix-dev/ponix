...
func (srv *DataEnvelopeService) ConsumeProcessedEnvelope(ctx context.Context, envelope *envelopev1.ProcessedEnvelope) error {
	ctx, span := telemetry.Tracer().Start(ctx, "ConsumeProcessedEnvelope")
	defer span.End()
