...
require (
	buf.build/gen/go/ponix/ponix/connectrpc/go v1.17.0-20250103114916-fc275fdc346e.1
	buf.build/gen/go/ponix/ponix/protocolbuffers/go v1.36.1-20250103114916-fc275fdc346e.1
