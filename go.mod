...
require (
	buf.build/gen/go/ponix/ponix/connectrpc/go v1.17.0-20250103025228-cea47d50e4d0.1
	buf.build/gen/go/ponix/ponix/protocolbuffers/go v1.36.1-20250103025228-cea47d50e4d0.1
